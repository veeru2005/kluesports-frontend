      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col gap-8 md:gap-12">
          ...
          <div
            ...
            className={`max-w-4xl mx-auto text-center scroll-fade-up ${leftContent.isVisible ? 'scroll-visible' : ''}`}
          >
          ...
          {/* Sponsors Section */}
          <div ref={sponsorsAnim.elementRef} className={`space-y-8 text-center ${sponsorsAnim.isVisible ? 'scroll-visible' : 'scroll-fade-up'}`}>
            ...
            <div className="grid grid-cols-2 md:flex md:flex-wrap justify-center items-center gap-6 md:gap-24 max-w-7xl mx-auto px-4 md:px-0">
              {sponsors.map((sponsor, index) => (
                <div key={index} className="flex flex-col items-center gap-4 group w-full md:w-auto">
                  <div className="relative w-24 h-24 md:w-36 md:h-36 flex items-center justify-center rounded-full overflow-hidden transition-all duration-500 border-2 border-primary group-hover:shadow-[0_0_30px_rgba(220,38,38,0.6)] bg-white">
                    <img
                      src={sponsor.logo}
                      alt={sponsor.name}
                  ...
                  <div className="bg-primary px-3 md:px-6 py-2 rounded-lg shadow-lg w-full max-w-[140px] md:max-w-[220px] text-center">
